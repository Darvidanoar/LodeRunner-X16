...
static struct soundFx_t goldFx = {
    ...
    0x1,    // Channel 1
    {
        ...
        YM_KS_AR, 0xf1,
        YM_AMS_EN_D1R, 0xa0,
        YM_D1L_RR, 0xff,      // M1: RR=15
        YM_D1L_RR+8, 0xff,    // C1: RR=15
        YM_D1L_RR+16, 0xff,   // M2: RR=15
        YM_D1L_RR+24, 0xff,   // C2: RR=15
...
static struct soundFx_t deadFx = {
    ...
    0x2,    // Channel 2
    {
        ...
        YM_D1L_RR+8+YM_CH_2, 0xff,
        YM_D1L_RR+16+YM_CH_2, 0xff,
        YM_D1L_RR+24+YM_CH_2, 0xff,
        YM_KC+YM_CH_2, 0x44,
...
static struct soundFx_t fallFx = {
    ...
    0x10,   // Channel 5
    {
        ...
        YM_D1L_RR+YM_CH_5, 0xef,
        YM_D1L_RR+8+YM_CH_5, 0xef,
        YM_D1L_RR+16+YM_CH_5, 0xef,
        YM_D1L_RR+24+YM_CH_5, 0xef,
...
static struct soundFx_t passFx = {
    ...
    0x10,   // Channel 5
    {
        ...
        YM_D1L_RR+8+YM_CH_5, 0xff,
        YM_D1L_RR+16+YM_CH_5, 0xff,
        YM_D1L_RR+24+YM_CH_5, 0xff,
